	...
	for(var h = 0; h < surveyJsonList.length; h++)
	{
		...
		if(surveyJson.inputAddYn=='Y') //직접입력추가
		{
			...
			$("#surveyExmpl-"+surveyJson.surveyNo).append(
				...
				+'		<button type="button" id="inputAddButton" class="btn_style2_4" onclick="javascript:fnExcelDown(\'I\',\''+surveyJson.surveyNo+'\',\''+iCnt+'\',\''+inputAddNo+'\');">엑셀받기</button>'
				+'	</span>'
				+'</div>'
			);
		...
		{			
			...
			$("#surveyExmpl-"+surveyJson.surveyNo).append(
				...
				+'		<button type="button" id="singleTxtButton" class="btn_style2_4"  onclick="javascript:fnExcelDown(\'S\',\''+surveyJson.surveyNo+'\',\''+iCnt+'\',\'\');">엑셀받기</button>'
				+'	</span>'
				+'</div>'
			);			
		}
